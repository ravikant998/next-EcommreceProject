...
import { productDetail } from '../../store/productDetailsSlice'
...
const Slug = ({ addToCart }) => {
  ...
  useEffect(() => {
    if (id.slug)
      dispatch(productDetail(id.slug))
  }, [id])
    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-16 mx-auto">
       ...
       <ImageSlider data={data}/>
          {/* <Image alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src={data.images} width='500' height={500} /> */}
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              ...
              <button onClick={() => addToCart(id, 1, 499, 'shirts(XL,Red)', 'XL', "Red")} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
