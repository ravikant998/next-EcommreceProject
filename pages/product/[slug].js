    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://rukminim1.flixcart.com/image/832/832/l1grgcw0/t-shirt/x/o/5/m-t428hs-tm5p-eyebogler-original-imagdf2egzjxeqgk.jpeg?q=70" />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">Addidas</h2>
            ...
            <div className="flex">
              ...
              <button onClick={()=>addToCart(slug,1,499,'shirts(XL,Red)','XL',"Red")} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
            ...
            <div className='pin mt-6 flex space-x-2 text-sm'>
              <input onChange={onChangePin} className='px-2 border-2 border-black' type='text' placeholder='Enter your Pincode' />
              <button
                onClick={checkavailability}
                className="flex ml-14 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none
                 hover:bg-pink-600 rounded">Check Service
              </button>
            </div>
            {
              !service && service != null && <div className='text-red-700 text-sm mt-3'>
                We do not deliver this pincode
              </div>
            }
            {
              service && service != null && <div className='text-green-700 text-sm mt-3'>
                We can deliver this pincode
              </div>
            }
